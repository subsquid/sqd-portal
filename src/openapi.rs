...
#[openapi(
    paths(
        ...
        crate::http_server::get_blocknumber_by_timestamp,
        crate::http_server::run_archival_stream_restricted,
        crate::http_server::run_archival_stream,
        crate::http_server::run_finalized_stream,
        crate::http_server::run_stream,
