...
| P-ASSIGNMENT-MAX-AGE | Assignment age past which the artifact is reported stale (REQ-23, ADR-016) | 900 s (`assignment_max_age_sec`) | 15 min; signalling only — readiness is independent of age |
